...
insert into subcategory (parent_id, category_id, title)
values (null, 1, 'Apple'),
       (null, 1, 'Samsung'),
       (null, 1, 'Huawei'),
       (null, 2, 'Наушники'),
       (null, 2, 'Колонки'),
       (4, 2, 'Беспроводные наушники'),
       (4, 2, 'Проводные наушники'),
       (5, 2, 'Портативные колонки'),
       (5, 2, 'Колонки с голосовым помощником'),
       (null, 3, 'Чехлы'),
       (null, 3, 'Зарядные устройства'),
       (null, 3, 'Защитные стекла'),
       (10, 3, 'Чехлы на IPhone'),
       (10, 3, 'Чехлы на Samsung'),
       (10, 3, 'Чехлы на Huawei'),
       (11, 3, 'Зарядные устройства lightning'),
       (11, 3, 'Зарядные устройства Type-C'),
       (11, 3, 'Зарядные устройства micro USB'),
       (12, 3, 'Стекла на IPhone'),
       (12, 3, 'Стекла на Samsung'),
       (12, 3, 'Стекла на Huawei');
...
insert into property (product_property_id, name, value)
values (111, 'Модель', 'Apple IPhone 12'),
       (111, 'Память', '128 Гб'),
       (111, 'Цвет', 'Белый'),
       (111, 'Емкость аккумулятора', '2815 мАч'),
       (111, 'Страна производитель', 'Китай'),
       (112, 'Модель', 'Apple IPhone 13'),
       (112, 'Память', '256 Гб'),
       (112, 'Цвет', 'Белый'),
       (112, 'Емкость аккумулятора', '2815 мАч'),
       (112, 'Страна производитель', 'Китай'),
       (113, 'Модель', 'Apple IPhone 14'),
       (113, 'Память', '128 Гб'),
       (113, 'Цвет', 'Белый'),
       (113, 'Емкость аккумулятора', '3200 мАч'),
       (113, 'Страна производитель', 'Китай'),
       (121, 'Модель', 'Samsung S22'),
       (121, 'Память', '128 Гб'),
       (121, 'Цвет', 'Лавандовый'),
       (121, 'Емкость аккумулятора', '3590 мАч'),
       (121, 'Страна производитель', 'Вьетнам'),
       (122, 'Модель', 'Samsung S22+'),
       (122, 'Память', '256 Гб'),
       (122, 'Цвет', 'Белый'),
       (122, 'Емкость аккумулятора', '4370 мАч'),
       (122, 'Страна производитель', 'Китай'),
       (123, 'Модель', 'Samsung S21'),
       (123, 'Память', '128 Гб'),
       (123, 'Цвет', 'Белый'),
       (123, 'Емкость аккумулятора', '3880 мАч'),
       (123, 'Страна производитель', 'Китай'),
       (124, 'Модель', 'Samsung S21'),
       (124, 'Память', '256 Гб'),
       (124, 'Цвет', 'Лаандовый'),
       (124, 'Емкость аккумулятора', '3880 мАч'),
       (124, 'Страна производитель', 'Вьетнам'),
       (131,'Модель', 'HUAWEI P50 Pocket'),
       (131, 'Память', '512 Гб'),
       (131, 'Цвет', 'Золотой'),
       (131, 'Емкость аккумулятора', '3900 мАч'),
       (131, 'Страна производитель', 'Китай'),
       (132,'Модель', 'HUAWEI P50 Pocket'),
       (132, 'Память', '256 Гб'),
       (132, 'Цвет', 'Золотой'),
       (132, 'Емкость аккумулятора', '3900 мАч'),
       (132, 'Страна производитель', 'Китай'),
       (133,'Модель', 'HUAWEI P50'),
       (133, 'Память', '256 Гб'),
       (133, 'Цвет', 'Черный'),
       (133, 'Емкость аккумулятора', '4100 мАч'),
       (133, 'Страна производитель', 'Китай'),
       (211, 'Модель', 'Samsung Buds 2'),
       (211, 'Bluetooth', '5.2'),
       (211, 'Цвет', 'Черный'),
       (211, 'Емкость аккумулятора', '61 мАч'),
       (211, 'Страна производитель', 'Вьетнам'),
       (212, 'Модель', 'Samsung Buds 2'),
       (212, 'Bluetooth', '5.2'),
       (212, 'Цвет', 'Белый'),
       (212, 'Емкость аккумулятора', '61 мАч'),
       (212, 'Страна производитель', 'Вьетнам'),
       (213, 'Модель', 'Xiaomi Redmi Buds 4 Pro'),
       (213, 'Bluetooth', '5.3'),
       (213, 'Цвет', 'Черный'),
       (213, 'Емкость аккумулятора', '50 мАч'),
       (213, 'Страна производитель', 'Китай'),
       (214, 'Модель', 'Sony WF-1000XM4'),
       (214, 'Bluetooth', '5.2'),
       (214, 'Цвет', 'Черный'),
       (214, 'Емкость аккумулятора', '50 мАч'),
       (214, 'Страна производитель', 'Китай'),
       (215, 'Модель', 'Edifier W820NB'),
       (215, 'Bluetooth', '5.0'),
       (215, 'Цвет', 'Черный'),
       (215, 'Емкость аккумулятора', '400 мАч'),
       (215, 'Страна производитель', 'Китай'),
       (216, 'Модель', 'Razer Barracuda X'),
       (216, 'Цвет', 'Белый'),
       (216, 'Игровые наушники', 'Да'),
       (216, 'Подсветка', 'Нет'),
       (216, 'Страна производитель', 'Германия'),
       (217, 'Модель', 'PlayStation PULSE 3D'),
       (217, 'Цвет', 'Белый'),
       (217, 'Игровые наушники', 'Да'),
       (217, 'Подсветка', 'Нет'),
       (217, 'Страна производитель', 'Япония'),
       (218, 'Модель', 'Apple EarPods (Lightning)'),
       (218, 'Цвет', 'Белый'),
       (218, 'Игровые наушники', 'Нет'),
       (218, 'Подсветка', 'Нет'),
       (218, 'Страна производитель', 'Япония'),
       (219, 'Модель', 'SVEN AP-U980MV'),
       (219, 'Цвет', 'Черный'),
       (219, 'Игровые наушники', 'Да'),
       (219, 'Подсветка', 'Разноцветная'),
       (219, 'Страна производитель', 'Вьетнам'),
       (221, 'Модель', 'JBL GO 3'),
       (221, 'Цвет', 'Черный'),
       (221, 'Мощность', '4.2 Вт'),
       (221, 'Bluetooth', '5.1'),
       (221, 'Емкость аккумулятора', '750мАч'),
       (221, 'Страна производитель', 'Китай'),
       (222, 'Модель', 'DEXP P570'),
       (222, 'Цвет', 'Черный'),
       (222, 'Мощность', '50 Вт'),
       (222, 'Bluetooth', '5.1'),
       (222, 'Емкость аккумулятора', '3600 мАч'),
       (222, 'Страна производитель', 'Китай'),
       (223, 'Модель', 'JBL Xtreme 3'),
       (223, 'Цвет', 'Черный'),
       (223, 'Мощность', '100 Вт'),
       (223, 'Bluetooth', '5.1'),
       (223, 'Емкость аккумулятора', '5000 мА*ч'),
       (223, 'Страна производитель', 'Китай'),
       (224, 'Модель', 'Яндекс Станция Макс'),
       (224, 'Цвет', 'Черный'),
       (224, 'Мощность', '65 Вт'),
       (224, 'Bluetooth', '4.2'),
       (224, 'Питание', 'От сети'),
       (224, 'Страна производитель', 'Китай'),
       (225, 'Модель', 'Новая Яндекс.Станция Мини'),
       (225, 'Цвет', 'Серый'),
       (225, 'Мощность', '10 Вт'),
       (225, 'Bluetooth', '5.0'),
       (225, 'Питание', 'От сети'),
       (225, 'Страна производитель', 'Китай'),
       (226, 'Модель', 'Яндекс Станция Лайт'),
       (226, 'Цвет', 'Бежевый'),
       (226, 'Мощность', '5 Вт'),
       (226, 'Bluetooth', '5.0'),
       (226, 'Питание', 'От сети'),
       (226, 'Страна производитель', 'Китай'),
       (311, 'Модель', 'Apple Silicone Case with MagSafe'),
       (311, 'Материал', 'ТПУ'),
       (311, 'Цвет', 'синий'),
       (312, 'Модель', 'Apple Silicone Case with MagSafe'),
       (312, 'Материал', 'ТПУ'),
       (312, 'Цвет', 'фиолетовый'),
       (313, 'Модель', 'Apple Silicone Case with MagSafe'),
       (313, 'Материал', 'ТПУ'),
       (313, 'Цвет', 'синий'),
       (314, 'Модель', 'Apple Clear Case with MagSafe'),
       (314, 'Материал', 'поликарбонат'),
       (314, 'Цвет', 'прозрачный'),
       (315, 'Модель', 'Apple Leather Case with MagSafe'),
       (315, 'Материал', 'натуральная кожа, поликарбонат'),
       (315, 'Цвет', 'коричневый'),
       (316, 'Модель', 'Apple Leather Case with MagSafe'),
       (316, 'Материал', 'натуральная кожа, поликарбонат'),
       (316, 'Цвет', 'черный'),
       (317, 'Модель', 'Apple Silicone Case with MagSafe'),
       (317, 'Материал', 'ТПУ'),
       (317, 'Цвет', 'желтый'),
       (318, 'Модель', 'Samsung Smart Clear View Cover'),
       (318, 'Материал', 'поликарбонат, полиуретан'),
       (318, 'Цвет', 'черный'),
       (319, 'Модель', 'Samsung Silicone Cover with Strap'),
       (319, 'Материал', 'поликарбонат, ТПУ'),
       (319, 'Цвет', 'синий'),
       (320, 'Модель', 'DF'),
       (320, 'Материал', 'ТПУ'),
       (320, 'Цвет', 'прозрачный'),
       ...
       (321, 'Материал', 'ТПУ'),
       (321, 'Цвет', 'черный'),
       (322, 'Модель', 'Aceline Strap'),
       (322, 'Материал', 'полиуретан, ТПУ'),
       (322, 'Цвет', 'черный'),
       (323, 'Разъем 1', 'Lightning 8-pin MFI'),
       (323, 'Зазъем 2', 'USB'),
       (323, 'Длина', '1 м'),
       (324, 'Разъем 1', 'Lightning 8-pin MFI'),
       (324, 'Зазъем 2', 'USB Type-C'),
       (324, 'Длина', '1 м'),
       (325, 'Разъем 1', 'Lightning 8-pin'),
       (325, 'Зазъем 2', 'USB Type-C'),
       (325, 'Длина', '1 м'),
       (326, 'Разъем 1', 'USB Type-C'),
       (326, 'Зазъем 2', 'USB Type-C'),
       (326, 'Длина', '1 м'),
       (327, 'Разъем 1', 'USB Type-C'),
       (327, 'Зазъем 2', 'USB'),
       (327, 'Длина', '1 м'),
       (328, 'Разъем 1', 'micro USB'),
       (328, 'Зазъем 2', 'USB'),
       (328, 'Длина', '1 м'),
       (329, 'Модель', 'Apple'),
       (329, 'Совместимые модели', 'Apple iPhone 13 Pro, Apple iPhone 13, Apple iPhone 14'),
       (329, 'Вид стекла', '2.5D'),
       (330, 'Модель', 'Apple'),
       (330, 'Совместимые модели', 'Apple iPhone 12 Pro, Apple iPhone 12'),
       (330, 'Вид стекла', '2.5D'),
       (331, 'Модель', 'Samsung'),
       (331, 'Совместимые модели', 'Samsung Galaxy A22 5G, Samsung Galaxy A22s 5G'),
       (331, 'Вид стекла', '2.5D');

insert into product (product_property_id, title, description, amount, picture_url, price, discount_price, discount, subcategory_id)
values (111, 'Apple IPhone 12', 'Дисплей представляет собой прямоугольник с закруглёнными углами. Диагональ этого прямоугольника без учёта закруглений составляет 5,42 дюйма (для iPhone 12 mini), 5,85 дюйма (для iPhone 11 Pro, iPhone XS, iPhone X), 6,06 дюйма (для iPhone 12 Pro, iPhone 12, iPhone 11, iPhone XR), 6,46 дюйма (для iPhone 11 Pro Max, iPhone XS Max) или 6,68 дюйма (для iPhone 12 Pro Max). Фактическая область просмотра меньше.',
       ...
       (112, 'Apple IPhone 13', 'Apple iPhone 13 обладает по-настоящему превосходным экраном с высокой яркостью и контрастностью, однако у него есть два недостатка. Во-первых, дисплей имеет стандартную частоту обновления 60 Гц, тогда как конкуренты имеют 120 Гц. Во-вторых, хоть размеры выреза в дисплее уменьшились, он все равно кажется большим. При просмотре HDR-контента яркость вырастает до целых 1200 нит, а в стандартном режиме – 800 нит. Минимальная яркость тоже отличная – дисплей не будет слепить пользователя ночью.',
        ...
        75000, 70000, true, 1),
       (113, 'Apple IPhone 14', 'Защита экрана Ceramic Shield, прочная как никакое другое стекло. Водонепроницаемость. Алюминий, используемый в аэрокосмической отрасли. Два размера на выбор, 6.1 дюйма и 6.7 дюйма. И самое долгое время работы от батареи в истории iPhone.',
        5, 'https://cdn.svyaznoy.ru/upload/iblock/000/0004936c8766c3d968e4ee3e56daf053.jpg/resize/453x480//',
        89000, 75000, true, 1),
       (121, 'Samsung S22', 'Смартфон Samsung Galaxy S22 с оперативной памятью объемом 8 Гб и встроенной — 128 Гб обладает безрамочным сенсорным экраном диагональю 6,1 дюйма, созданным с использованием технологии Dynamic AMOLED 2X.',
        11, 'https://img.mvideo.ru/Big/30065802bb.jpg',
        58000, 56000, true, 2),
       (122, 'Samsung S22+', 'Смартфон Samsung Galaxy S22+, белый поддерживает работу двух nano-SIM и eSim карт в сетях 2G-5G. Высокую вычислительную способность устройства на операционной системе Android 12 обеспечивают восьмиядерный процессор Samsung Exynos 2200, оперативная (8 Гб) и внутренняя (128 Гб) память.',
       ...
       (123, 'Samsung S21', 'Вы больше никогда не пропустите тот идеальный момент для снимка. Встречайте Samsung Galaxy S21 5G и S21+ 5G, созданные произвести революцию в мире видеосъемки и фотографии. С более чем кинематографическим разрешением 8K вы можете делать невероятные фотографии прямо из видео. Это все есть в обеих моделях: 64 МП, самый шустрый чип Samsung и мощный аккумулятор на весь день. Они просто стали легендарными.',
        ...
        57000, 55000, true, 2),
       (124, 'Samsung S21', 'Вы больше никогда не пропустите тот идеальный момент для снимка. Встречайте Samsung Galaxy S21 5G и S21+ 5G, созданные произвести революцию в мире видеосъемки и фотографии. С более чем кинематографическим разрешением 8K вы можете делать невероятные фотографии прямо из видео. Это все есть в обеих моделях: 64 МП, самый шустрый чип Samsung и мощный аккумулятор на весь день. Они просто стали легендарными.',
        2, 'https://cdn.svyaznoy.ru/upload/iblock/a05/samsung_pd_sm_g991_bzvgser_900x1200_1.jpg',
        67000, 65000, true, 2),
       (131, 'HUAWEI P50 Pocket', 'Необычная раскладная конструкция смартфона Huawei P50 Pocket с объемом встроенной памяти 512 ГБ не оставит равнодушным даже наиболее требовательного пользователя. Ощутить всю глубину просматриваемого контента с детальным отображением мельчайших элементов вам позволит 6.9-дюймовый дисплей, разрешение которого достигает 2790х1188 пикс. ',
        ...
        69000, 67000, true, 3),
       (132, 'HUAWEI P50 Pocket', 'Необычная раскладная конструкция смартфона Huawei P50 Pocket с объемом встроенной памяти 512 ГБ не оставит равнодушным даже наиболее требовательного пользователя. Ощутить всю глубину просматриваемого контента с детальным отображением мельчайших элементов вам позволит 6.9-дюймовый дисплей, разрешение которого достигает 2790х1188 пикс. ',
       ...
       (214, 'Наушники TWS Sony WF-1000XM4 черный', 'Оснащенные амбушюрами из мягкой пены наушники TWS Sony WF-1000XM4 исключительно комфортны. Устройство станет оправданным выбором для любителей музыки, являющихся поклонниками активного образа жизни. Наушники, соответствующие концепции True Wireless Stereo, лишены проводов полностью: амбушюры не связаны между собой физически. Устройство защищено от воздействия дождя.',
        ...
        18500, 18000, true, 6),
       (215, 'Bluetooth-гарнитура Edifier W820NB черный', 'Bluetooth гарнитура Edifier W820NB благодаря высокой функциональности и качеству звука подарит вам яркие эмоции при использовании. В основе модели используются излучатели динамического типа диаметром 40 мм. ',
        ...
        5000, 4000, true, 6),
       (216, 'Радиочастотная гарнитура Razer Barracuda X белый', 'Одна гарнитура для всего — Razer Barracuda X это универсальная, легкая беспроводная игровая гарнитура, предназначенная для легко соединяемого использования на ПК, PlayStation, Nintendo Switch и Android.',
        ...
        6000, 5000, true, 7),
       (217, 'Радиочастотная гарнитура PlayStation PULSE 3D белый', 'Наслаждайтесь безупречным качеством беспроводной связи благодаря гарнитуре, оптимизированной для 3D-звука на консолях PS5. Беспроводная гарнитура PULSE 3D имеет усовершенствованный дизайн и оснащена двумя микрофонами с шумоподавлением, зарядкой через USB Type-C и панелью с удобными элементами управления.',
        ...
        11000, 10000, true, 7),
       (218, 'Проводная гарнитура Apple EarPods (Lightning) белый', 'Гарнитура проводная Apple EarPods (Lightning) привлекает соотношением качеств и функциональности. Компактность - основное ее достоинство. Она имеет внушительную широкую совместимость с разнотипными устройствами Apple. Данная гарнитура соответствует формату стерео, обладает дополнительной шумоизоляцией, что положительно сказывается на звуке.',
        ...
        2500, 2000, true, 7),
       (219, 'Проводная гарнитура SVEN AP-U980MV черный', 'Наушники Sven AP-U980MV – отличное геймерское устройство. При их создании было реализовано объемное звучание в формате 7.1. Удалось повысить качество воспроизведения и получать еще больше удовольствия от использования.
       ...
       (221, 'Портативная колонка JBL GO 3 черный', 'Портативная колонка JBL GO 3 разработана специально для любителей прослушивания музыки, которые нуждаются в компактном и надежном решении на каждый день. Динамик мощностью 4.2 Вт воспроизводит насыщенный и четкий звук без искажений независимо от уровня громкости. Акустика подключается к устройствам посредством технологии Bluetooth 5.1 и оснащена разъемом USB Type-C.',
        ...
        4000, 3500, true, 8),
       (222, 'Портативная колонка DEXP P570 черный', 'Портативная колонка DEXP P570 благодаря стереодинамикам выходной мощностью 50 Вт обеспечивает воспроизведение четкого и реалистичного звука с насыщенными басами. Акустика способна проигрывать аудиоконтент в востребованных форматах с различных источников. ',
       ...
       (223, 'Портативная колонка JBL Xtreme 3 черный', 'Портативная колонка JBL Xtreme 3 отличается мощным звуком, который создают 4 динамика общей мощностью 50 Вт, а также два пассивных излучателя, работающие на низких частотах. Благодаря функции «PartyBoost» вы можете синхронизировать работу колонки другими колонками и динамиками для получения удивительного, объемного звучания.',
        ...
        28000, 26000, true, 8),
       (224, 'Умная колонка Яндекс Станция Макс черный', 'Умная колонка Яндекс.Станция Макс выполнена в компактном корпусе черного цвета. Модель имеет акустическую систему Hi-fi, семь микрофонов и обеспечивает просмотр видео в формате 4К. Устройство оснащено голосовым помощником Алиса. Изделие поддерживает опцию умного дома, поэтому пользователь может включить на расстоянии чайник, свет, любые устройства или задать другие команды.',
        ...
        29000, 26000, true, 9),
       (225, 'Умная колонка Новая Яндекс.Станция Мини (с часами) серый', 'Умная колонка Яндекс.Станция Мини выполнена в компактном круглом корпусе с отделкой из ткани в сером цвете и отличается широкими функциональными возможностями. Благодаря голосовому помощнику Алиса колонка умеет быстро отвечать на интересующие вопросы, запускать мультимедийный и развлекательный контент, выполнять поручения и осуществлять поиск необходимой информации. ',
       ...
       (320, 'Накладка DF для Samsung Galaxy S22 прозрачный', 'Накладка DF ‒ легкий, тонкий и прочный защитный аксессуар для Samsung Galaxy S22. Он накладывается на заднюю панель, бока смартфона, закрывая его углы от ударов. Благодаря плотному контакту с поверхностью чехол эффективен в защите от влаги, пыли, мелкого мусора. Прозрачный аксессуар сохраняет оформление устройства, его цвет таким, каки задумал дизайнер.',
        ...
        1000, 500, false, 14),
       (321, 'Накладка DF для HUAWEI P50 черный', 'Накладка DF для HUAWEI P50 из термопластичного полиуретана полностью соответствует особенностям данной модели смартфона и помогает предотвратить различные повреждения. Благодаря гибкости материала чехол плотно и удобно фиксируется на корпусе, а также легко снимается при необходимости. ',
       ...
       (326, 'Кабель круглый WIIIX USB Type-C - USB Type-C черный 1 м', 'Кабель WIIIX USB Type-C - USB Type-C оснащен двумя разъемами с симметричной конструкцией, обеспечивая удобство синхронизации при необходимости передачи файлов или подзарядки устройств. Поддержка протокола быстрого заряда помогает сократить время на восстановление энергоресурса аккумулятора. ',
        ...
        500, 450, false, 17),
       (327, 'Кабель круглый WIIIX USB Type-C - USB черный 1 м', 'Кабель круглый WIIIX USB Type-C - USB с черным цветовым исполнением рассчитан на подключение мобильных устройств с разъемом USB-C для зарядки аккумулятора или передачи данных между смартфоном/планшетом и ПК, ноутбуком. ',
       ...
       (328, 'Сетевое зарядное устройство DEXP IET002048 черный', 'Сетевое зарядное устройство DEXP IET002048 позволит вам не беспокоиться о низком заряде батареи вашего смартфона, ведь вы сможете пополнить его емкость в любое время при наличии поблизости электророзетки. Зарядный блок выполнен в гармоничном сочетании белого и черного цветов, которое вот уже на протяжении многих десятилетий является одной из самых модных тенденций. ',
        ...
        600, 450, false, 18),
       (329, '6.1" Защитное стекло Red Line для экрана Apple iPhone 13/ 13 Pro/ 14', 'Защитное стекло RedLine полностью закрывает экран вашего смартфона и надежно защищает его от повреждений. Это самый надежный и технологичный способ сохранить экран вашего устройства в первозданном виде.',
       ...
       (329, '6.1" Защитное стекло Red Line для экрана Apple iPhone 12/ 12 Pro', '6.1" Защитное стекло Red Line для смартфона Apple IPhone 12/12 Pro обезопасит экран от царапин, потертостей и последствий удара. 2.5D стекло с черной рамкой имеет олеофобное покрытие, благодаря которому отпечатки пальцев на нем менее заметны и легко удаляются. Клей по всей поверхности стекла обеспечивает отсутствие точек и эффекта масляного пятна на поверхности экрана.',
        ...
        1000, 800, true, 19),
       (329, '6.6" Защитное стекло DF для экрана Samsung Galaxy A22s 5G/ A22 5G', 'Защитное стекло спроектировано точно и полностью закрывает изогнутый по краям экран смартфона. Цветная рамка подчеркивает контуры экрана. Олеофобное покрытие предотвратит появление следов от пальцев, сохранит чувствительность сенсора на 100%, уменьшит блики на экране. Данный аксессуар максимально защитит экран смартфона от царапин, повреждений, влаги и ударов',
